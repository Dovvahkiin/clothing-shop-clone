...
$sqlUcitavanjeUpit = "SELECT * FROM proizvod WHERE tipProizvoda= 'zenskaMajica' ";
$sveMajice = $konekcija->query($sqlUcitavanjeUpit);
...
<meta charset="UTF-8">
    ...
    <title>Mona | Ženske Majice</title>
</head>
<body>
...
<?php
    foreach($sveMajice as $majice){
?>

<div class="kategorije">
<a href="proizvod.php?imeProizvoda=<?php echo urlencode($majice['imeProizvoda']) ?>">
<h1><?php echo $majice["imeProizvoda"] ?></h1>
    <hr>
    <img src="<?php echo $majice["slika"] ?>" class="slikaOdeca" alt="">
    <hr>
    <p>Cena: <?php echo $majice["cenaProizvoda"]?> dinara</p>
</a>
</div>
