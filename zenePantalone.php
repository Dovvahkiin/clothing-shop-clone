...
$sqlUcitavanjeUpit = "SELECT * FROM proizvod WHERE tipProizvoda= 'zenskePantalone' ";
$svePantalone = $konekcija->query($sqlUcitavanjeUpit);
...
<meta charset="UTF-8">
    ...
    <title>Mona | Ženske Pantalone</title>
</head>
<body>
...
<?php
    foreach($svePantalone as $pantalone){
?>

<div class="kategorije">
<a href="proizvod.php?imeProizvoda=<?php echo urlencode($pantalone['imeProizvoda']) ?>">
<h1><?php echo $pantalone["imeProizvoda"] ?></h1>
    <hr>
    <img src="<?php echo $pantalone["slika"] ?>" class="slikaOdeca" alt="">
    <hr>
    <p>Cena: <?php echo $pantalone["cenaProizvoda"]?> dinara</p>
</a>
</div>
