...
$sqlUcitavanjeUpit = "SELECT * FROM proizvod WHERE tipProizvoda= 'zenskaJakna' ";
$sveJakne = $konekcija->query($sqlUcitavanjeUpit);
...
<?php
    foreach($sveJakne as $jakne){
?>

<div class="kategorije">
<a href="proizvod.php?imeProizvoda=<?php echo urlencode($jakne['imeProizvoda']) ?>">
<h1><?php echo $jakne["imeProizvoda"] ?></h1>
    <hr>
    <img src="<?php echo $jakne["slika"] ?>" class="slikaOdeca" alt="">
    <hr>
    <p>Cena: <?php echo $jakne["cenaProizvoda"]?> dinara</p>
</a>
</div>
