...
$sqlUcitavanjeUpit = "SELECT * FROM proizvod WHERE tipProizvoda= 'kravata' ";
$sveKravate = $konekcija->query($sqlUcitavanjeUpit);
...
<?php
    foreach($sveKravate as $kravate){
?>

<div class="kategorije">
<a href="proizvod.php?imeProizvoda=<?php echo urlencode($kravate['imeProizvoda']) ?>">
<h1><?php echo $kravate["imeProizvoda"] ?></h1>
    <hr>
    <img src="<?php echo $kravate["slika"] ?>" class="slikaOdeca" alt="">
    <hr>
    <p>Cena: <?php echo $kravate["cenaProizvoda"]?> dinara</p>
</a>
</div>
