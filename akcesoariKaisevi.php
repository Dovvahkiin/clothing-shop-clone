...
session_start();
$sqlUcitavanjeUpit = "SELECT * FROM proizvod WHERE tipProizvoda= 'kais' ";
$sviKaisevi = $konekcija->query($sqlUcitavanjeUpit);
...
<?php
    foreach($sviKaisevi as $kaisevi){
?>

<div class="kategorije">
<a href="proizvod.php?imeProizvoda=<?php echo urlencode($kaisevi['imeProizvoda']) ?>">
<h1><?php echo $kaisevi["imeProizvoda"] ?></h1>
    <hr>
    <img src="<?php echo $kaisevi["slika"] ?>" class="slikaOdeca" alt="">
    <hr>
    <p>Cena: <?php echo $kaisevi["cenaProizvoda"]?> dinara</p>
</a>
</div>
